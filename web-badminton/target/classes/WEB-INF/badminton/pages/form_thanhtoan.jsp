...
<html lang="en">
  ...
  <body>
    <div class="container">
      ...
      <!-- form thanh toán -->
        <form action="${pageContext.request.contextPath}/formthanhtoanCustomer" method="post">
            <div class="slider1">
                <div class="slider-1-container">
                    ...
                    <div class="slider-1-content">
                        <div class="form-group">
                            ...
                            <input type="text" id="customer-id" name="customer-id" value="${customerId}" readonly />
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="time-of-booking" name="time-of-booking" value="${timeOfBooking}" readonly />
                        </div>
                        <div class="form-group">
                            <label for="amount-type">Loại đặt sân</label>
                            <input type="text" id="amount-type" name="amount-type" value="${amountType}" readonly />
                        </div>
                        <div class="form-group">
