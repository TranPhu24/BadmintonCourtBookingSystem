...
<html lang="en">
  ...
  <body>
    <div class="container">
      ...
      <form action="${pageContext.request.contextPath}/dangkiSlotManager" method="post">
      <div class="slider-1">
                ...
                <tbody>
				  ...
				  <c:forEach var="slot" items="${slotList}">
				    <tr>
				      ...
				      <td>
				        <a href="${pageContext.request.contextPath}/editSlot?id=${slot.slotId}">Sửa</a> | 
				        <a href="${pageContext.request.contextPath}/deleteSlot?id=${slot.slotId}" onclick="return confirm('Bạn có chắc chắn muốn xóa slot này?');">Xóa</a>
				      </td>
				    </tr>
				  </c:forEach>
				</tbody>
