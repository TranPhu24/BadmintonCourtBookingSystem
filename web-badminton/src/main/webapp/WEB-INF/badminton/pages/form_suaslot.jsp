  ...
  <body>
    <div class="container">
      <header>
        ...
        <form action="${pageContext.request.contextPath}/formsuaslot" method="post">
            <div class="slider1">
                <div class="slider-1-container">
                    <h1>Sửa slot</h1>
                    <div class="slider-1-content">
                        <div class="form-group">
                            <label for="customer-id">Mã slot</label>
                            <input type="text" id="customer-id" name="slot-id" value="${slotId}" readonly />
                        </div>
                        <div class="form-group">
